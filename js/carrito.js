// ============================================================
// 🛒 carrito.js - Funcional y corregido
// ============================================================

document.addEventListener('DOMContentLoaded', () => {
  console.log('carrito.js cargado ✔️');
  ...
  if (!contenedor) {
    console.error('❌ No se encontró el elemento #carrito-container');
    return;
  }
  ...
  function renderCarrito() {
    ...
    carrito.forEach((producto, index) => {
      const img = producto.imagen || producto.img || '../imagenes/default.jpg';
    ...
    btn.addEventListener("click", () => {
      ...
      if (metodo === "efectivo") {
        contenido = `
          ...
          <button id="confirmarPago" class="btn btn-confirm">Confirmar pago</button>
        `;
      }
      ...
      // Listener del botón generado dinámicamente
      setTimeout(() => {
